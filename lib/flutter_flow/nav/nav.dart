      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => FeedWidget(
            filterCommunity: params.getParam(
              'filterCommunity',
        ...
        FFRoute(
          name: ListCommunityWidget.routeName,
          path: ListCommunityWidget.routePath,
          builder: (context, params) => ListCommunityWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: CriarpubliWidget.routeName,
          path: CriarpubliWidget.routePath,
          builder: (context, params) => CriarpubliWidget(),
        ),
        FFRoute(
          name: CriarComunidadeWidget.routeName,
          path: CriarComunidadeWidget.routePath,
          builder: (context, params) => CriarComunidadeWidget(),
        ),
        FFRoute(
          name: CommentsWidget.routeName,
          path: CommentsWidget.routePath,
          asyncParams: {
            'postRefence': getDoc(['post'], PostRecord.fromSnapshot),
          },
          builder: (context, params) => CommentsWidget(
            postRefence: params.getParam(
              'postRefence',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: EditPubliWidget.routeName,
          path: EditPubliWidget.routePath,
          asyncParams: {
            'publi': getDoc(['post'], PostRecord.fromSnapshot),
          },
          builder: (context, params) => EditPubliWidget(
            publi: params.getParam(
              'publi',
              ParamType.Document,
            ),
          ),
